...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container-fluid">
        <div class="border my-4">
            <form id="filterForm" name="filterForm" method="GET" action="{{ route('pegawai.index') }}" class="flex gap-4 justify-content-between w-full p-6">
                <div class="w-100 flex items-center gap-2 ">
                    <label for="employee name">Nip</label>
                    <input type="number" class="form-control" id="nip" name="nip" placeholder="01293">
                </div>
                <div class="w-100 flex items-center gap-2">
                    <label for="employee name">Name</label>
                    <input type="text" class="form-control" id="employeeName" name="employeeName" placeholder="Andi">
                </div>
                        ...
                        <form action="{{ route('pegawai.store') }}" method="POST" class="">
                            <div class="modal-body">
                                ...
                                <div class="flex g-3 align-items-center">
                                    ...
                                    <div class="row gap-4">
                                        <input type="number" id="nip" name="nip" class="form-control-plaintext" value="00123">
                                        <input type="text" id="employee_name" name="employee_name" class="form-control">
                                        <select id="gender" name="gender" class="form-select" aria-label="">
